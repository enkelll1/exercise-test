...
@Service
public class ExerciseOpenApiServiceImpl implements ExerciseOpenApiService {
    ...
    public ExerciseOpenApiServiceImpl(
    ...
    public ExerciseOpenApiResponseDTO checkAndQueueRequest(String key) {
        ...
        if (value == null) {
            String message = queueRequest(key);
            return new ExerciseOpenApiResponseDTO().message(message);
        } else {
            return new ExerciseOpenApiResponseDTO().message("Request queued for key: "+key);
        }
    }
